...
test.describe('Globe Visualization', () => {
  ...
  test('should render the map canvas', async ({ page }: { page: Page }) => {
  ...
  test('should display map controls', async ({ page }: { page: Page }) => {
  ...
  test('map should be interactive - can zoom', async ({ page }: { page: Page }) => {
    // Get the map canvas
