...
test.describe('Main Application', () => {
  ...
  test('should display the GAIALINK brand header', async ({ page }) => {
  ...
  test('should display Connect Wallet button from RainbowKit', async ({ page }) => {
  ...
  test('should display Portfolio button', async ({ page }) => {
  ...
  test('should display SpoonOS instruction in footer', async ({ page }) => {
  ...
  test('should open Portfolio modal when portfolio button is clicked', async ({ page }) => {
